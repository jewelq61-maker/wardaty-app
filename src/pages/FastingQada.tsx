    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="sticky top-0 bg-background/95 backdrop-blur-lg z-10 border-b border-border">
        <div className="flex items-center justify-between p-4">
          ...
          <h1 className="text-xl font-bold">{t('fastingQada')}</h1>
        ...
        <Card className="glass shadow-elegant">
          ...
          <CardContent className="space-y-4">
              ...
              <PopoverTrigger asChild>
                ...
                >
                  {selectedDate ? (
                    ...
                    <span>{t('selectDate', { defaultValue: 'Select completion date' })}</span>
                  )}
                </Button>
              </PopoverTrigger>
            ...
            >
              ...
              {loading ? t('loading') : t('markCompleted')}
            </Button>
          </CardContent>
        </Card>
          ...
          <Card className="glass shadow-elegant">
            <CardHeader>
              <CardTitle className="text-lg">
                {t('completedDays', { defaultValue: 'Completed Days' })}
              </CardTitle>
            </CardHeader>
            <CardContent>
                      ...
                      <div>
                        ...
                        {entry.completed_at && (
                          <div className="text-xs text-muted-foreground">
                            {t('completedOn', { defaultValue: 'Completed' })}: {format(parseISO(entry.completed_at), 'PP', { locale: dateLocale })}
                          </div>
                        )}
                      </div>
                    </div>
